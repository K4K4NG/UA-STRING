...
def banner():
	clear()
	wel = '# WELCOME TO SC MELEDAK '
	wel2 = mark(wel, style='cyan')
	sol().print(wel2)
	au='AUTHOR    :  MELEDAK \nStatus    :  Premium\nWHATSAPP  :081322544391'
	pengembang1=nel(au,style="cyan")
	cetak(nel(pengembang1, title='INFORMASI MELEDAK HENGKER'))
...
def passwrd():
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			frs = nmf.split(' ')[0]
			pwv = ['sayang','sayangku','sayang123','bismillah','anjing','katasandi','sandi123','kontol','freefiree','mobilelegends','memek123','montoon','ngentod','sayank','sayankkamu','anakharam','jancok','akuncreck','kontolodon','kintil','doraemon','pikacu','memek123','persib','persib123','persija','persija123','anakmonton','anakepep','ankfrefire','onichan','ngentot','kenceng','pendil','galon123','katasandi','katasandine','katasandiku','lakasandine','engkodipit','jancok','jiancuk','akunfrefire','akunmontoon']
			if len(nmf)<6:
				if len(frs)<3:
					pass
				else:
